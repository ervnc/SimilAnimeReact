...
export namespace Prisma {
  ...
  */
  ...
  export type UsersSelect = {
    ...
    occupation?: boolean
    image?: boolean
    character?: boolean | CharactersFindManyArgs
  ...
  export type UsersGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'character' ? Array < CharactersGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? UsersCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'character' ? Array < CharactersGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export class Prisma__UsersClient<T> implements PrismaPromise<T> {
    ...
    character<T extends CharactersFindManyArgs = {}>(args?: Subset<T, CharactersFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Characters>>, PrismaPromise<Array<CharactersGetPayload<T>>>>;
  ...
  export type CharactersGroupByArgs = {
    ...
    by: Array<CharactersScalarFieldEnum>
  ...
  type GetCharactersGroupByPayload<T extends CharactersGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type CharactersGetPayload<
    ...
    : S extends undefined
    ? never
    : S extends CharactersArgs | CharactersFindManyArgs
    ?'include' extends U
    ? Characters  & {
    [P in TrueKeys<S['include']>]:
        P extends 'user' ? UsersGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'user' ? UsersGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Characters ? Characters[P] : never
  } 
    : Characters
  : Characters


  type CharactersCountArgs = Merge<
    Omit<CharactersFindManyArgs, 'select' | 'include'> & {
      select?: CharactersCountAggregateInputType | true
    }
  >

  export interface CharactersDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
     ...
     * })
    **/
    findUnique<T extends CharactersFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, CharactersFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Characters'> extends True ? CheckSelect<T, Prisma__CharactersClient<Characters>, Prisma__CharactersClient<CharactersGetPayload<T>>> : CheckSelect<T, Prisma__CharactersClient<Characters | null >, Prisma__CharactersClient<CharactersGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends CharactersFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, CharactersFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Characters'> extends True ? CheckSelect<T, Prisma__CharactersClient<Characters>, Prisma__CharactersClient<CharactersGetPayload<T>>> : CheckSelect<T, Prisma__CharactersClient<Characters | null >, Prisma__CharactersClient<CharactersGetPayload<T> | null >>
     ...
     * const charactersWithNameOnly = await prisma.characters.findMany({ select: { name: true } })
     * 
    **/
    findMany<T extends CharactersFindManyArgs>(
      args?: SelectSubset<T, CharactersFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<Characters>>, PrismaPromise<Array<CharactersGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__CharactersClient<Characters>, Prisma__CharactersClient<CharactersGetPayload<T>>>
    ...
    **/
    ...
    /**
     * Find one Characters that matches the filter or throw
     * `NotFoundError` if no matches were found.
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends CharactersAggregateArgs>(args: Subset<T, CharactersAggregateArgs>): PrismaPromise<GetCharactersAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, CharactersGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCharactersGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__CharactersClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  export type CharactersFindUniqueArgsBase = {
    ...
    **/
     ...
     * 
    **/
    include?: CharactersInclude | null
    /**
   ...
   */
  export interface CharactersFindUniqueArgs extends CharactersFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
   ...
   */
  export type CharactersFindUniqueOrThrowArgs = CharactersFindUniqueArgsBase
      

  /**
   * Characters: findFirstOrThrow
   */
  export type CharactersFindFirstOrThrowArgs = CharactersFindFirstArgsBase
  ...
  export type UsersWhereInput = {
    ...
    height?: FloatFilter | number
    blood_type?: StringFilter | string
    gender?: StringFilter | string
    sexuality?: StringFilter | string
    birth_date?: StringFilter | string
    zodiac_sign?: StringFilter | string
    mbti?: StringFilter | string
  ...
  export type UsersScalarWhereWithAggregatesInput = {
    ...
    height?: FloatWithAggregatesFilter | number
    blood_type?: StringWithAggregatesFilter | string
    gender?: StringWithAggregatesFilter | string
    sexuality?: StringWithAggregatesFilter | string
    birth_date?: StringWithAggregatesFilter | string
    zodiac_sign?: StringWithAggregatesFilter | string
    mbti?: StringWithAggregatesFilter | string
  ...
  export type CharactersWhereInput = {
    ...
    name?: StringFilter | string
    usersUsername?: StringFilter | string
    weight?: FloatFilter | number
    height?: FloatFilter | number
    blood_type?: StringFilter | string
    gender?: StringFilter | string
    ...
    mbti?: StringFilter | string
    occupation?: StringFilter | string
    similarity?: StringFilter | string
    image?: StringFilter | string
  ...
  export type CharactersWhereUniqueInput = {
    name_usersUsername?: CharactersNameUsersUsernameCompoundUniqueInput
  }
  ...
  export type CharactersScalarWhereWithAggregatesInput = {
    ...
    name?: StringWithAggregatesFilter | string
    usersUsername?: StringWithAggregatesFilter | string
    weight?: FloatWithAggregatesFilter | number
    height?: FloatWithAggregatesFilter | number
    blood_type?: StringWithAggregatesFilter | string
    gender?: StringWithAggregatesFilter | string
    ...
    mbti?: StringWithAggregatesFilter | string
    occupation?: StringWithAggregatesFilter | string
    similarity?: StringWithAggregatesFilter | string
    image?: StringWithAggregatesFilter | string
  }
  ...
  export type UsersUpdateInput = {
    ...
    zodiac_sign?: StringFieldUpdateOperationsInput | string
  ...
  export type CharactersUpdateInput = {
    ...
    mbti?: StringFieldUpdateOperationsInput | string
    occupation?: StringFieldUpdateOperationsInput | string
    similarity?: StringFieldUpdateOperationsInput | string
    image?: StringFieldUpdateOperationsInput | string
  ...
  export type CharactersUncheckedUpdateInput = {
    name?: StringFieldUpdateOperationsInput | string
    usersUsername?: StringFieldUpdateOperationsInput | string
    weight?: FloatFieldUpdateOperationsInput | number
    height?: FloatFieldUpdateOperationsInput | number
    blood_type?: StringFieldUpdateOperationsInput | string
    gender?: StringFieldUpdateOperationsInput | string
  ...
  export type CharactersNameUsersUsernameCompoundUniqueInput = {
    name: string
    usersUsername: string
  }
  ...
  export type CharactersCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<CharactersCreateWithoutUserInput>, Enumerable<CharactersUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<CharactersCreateOrConnectWithoutUserInput>
    connect?: Enumerable<CharactersWhereUniqueInput>
  }
  ...
  export type CharactersUpdateManyWithoutUserNestedInput = {
    create?: XOR<Enumerable<CharactersCreateWithoutUserInput>, Enumerable<CharactersUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<CharactersCreateOrConnectWithoutUserInput>
    upsert?: Enumerable<CharactersUpsertWithWhereUniqueWithoutUserInput>
    set?: Enumerable<CharactersWhereUniqueInput>
    disconnect?: Enumerable<CharactersWhereUniqueInput>
    delete?: Enumerable<CharactersWhereUniqueInput>
    connect?: Enumerable<CharactersWhereUniqueInput>
    update?: Enumerable<CharactersUpdateWithWhereUniqueWithoutUserInput>
    updateMany?: Enumerable<CharactersUpdateManyWithWhereWithoutUserInput>
    deleteMany?: Enumerable<CharactersScalarWhereInput>
  }
  ...
  export type CharactersUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<CharactersUpdateManyMutationInput, CharactersUncheckedUpdateManyWithoutCharacterInput>
  }

  export type CharactersScalarWhereInput = {
    AND?: Enumerable<CharactersScalarWhereInput>
    OR?: Enumerable<CharactersScalarWhereInput>
    NOT?: Enumerable<CharactersScalarWhereInput>
    name?: StringFilter | string
    usersUsername?: StringFilter | string
    weight?: FloatFilter | number
    height?: FloatFilter | number
  ...
  export type CharactersUncheckedUpdateManyWithoutCharacterInput = {
    name?: StringFieldUpdateOperationsInput | string
    weight?: FloatFieldUpdateOperationsInput | number
    height?: FloatFieldUpdateOperationsInput | number
    blood_type?: StringFieldUpdateOperationsInput | string
